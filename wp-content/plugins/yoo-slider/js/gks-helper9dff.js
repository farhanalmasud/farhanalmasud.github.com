...
function gks_showSpinner(){jQuery("#gks-spinner").css('display','block');jQuery("#gks-spinner-background").css('display','block');}
function gks_hideSpinner(){setTimeout(function(){jQuery("#gks-spinner").css('display','none');jQuery("#gks-spinner-background").css('display','none');},1000);}
...
var picInfo={};picInfo.id=json.id;if(json.type=='image'){picInfo.src=json.sizes.full.url;if(json.sizes.medium){picInfo.src=json.sizes.medium.url;}}else if(json.type=='video'){picInfo.src=json.url;picInfo.thumb=gksPluginUrl+'/images/general/video_default.jpg';}
